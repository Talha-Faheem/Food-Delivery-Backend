...
export class RestaurantController {
  ...
  static async addRestaurant(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      // res.send(banner)
      // create categories
      const categoriesData =JSON.stringify( restaurant.categories.map((x: any) => {
...
static async getRestaurant(req: Request, res: Response, next: NextFunction){
  ...
  static async nearbyRestaurant(req: Request, res: Response, next: NextFunction)
   {
    // try {
  ...
  static async serachRestaurant(req: Request, res: Response, next: NextFunction)
   {
